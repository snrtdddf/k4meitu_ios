...
-(instancetype)init{
    ...
    if (self) {
        IPHONE_WIDTH>540?
        [self setFrame:CGRectMake(0, 0, SPW(30), SPW(30))]:
        [self setFrame:CGRectMake(0, 0, SPW(50), SPW(50))];
        _zanImage=[UIImage imageNamed:@"zan_se"];
...
-(void)initBaseLayout{
    ...
    switch (_type) {
        case CatZanButtonTypeFirework:{
            ...
            [_effectCell setContents:(__bridge id)[UIImage imageNamed:@"zan_fly"].CGImage];
            [_effectCell setAlphaSpeed:-1.0f];
            [_effectCell setLifetime:2.0f];
        ...
        case CatZanButtonTypeFirework:{
            ...
            [UIView animateWithDuration:0.5f delay:0 usingSpringWithDamping:0.3 initialSpringVelocity:5 options:UIViewAnimationOptionCurveLinear animations:^{
                ...
                if (self.isZan) {
                    ...
                    [effectLayerAnimation setFromValue:[NSNumber numberWithFloat:20]];
